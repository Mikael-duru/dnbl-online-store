...
// 						<h1 className="text-text-gray font-poppins-black font-black text-lg xs:text-2xl leading-[120%] sm:text-3xl md:text-[35.5px] lg:text-5xl lg:leading-[56px] tracking-[-0.96px] pb-[1.5%] xs:pb-4">
...
// 						<p className="text-white font-open-sans text-xs sm:text-xl lg:text-[28px] lg:leading-[40px] font-normal tracking-[-0.56px] pb-[5%] sm:pb-[38px]">
...
// 						<div
// 							key={index}
// 							className="w-[290px] h-[135px] xl:w-[344px] bg-white rounded-2xl py-[15px] shadow-incentives-shadow text-center"
// 						>
// 							<Image
// 								src={image}
// 								width={32}
...
// 								className="mx-auto"
// 							/>
// 							<p className="pt-2 text-black font-work-sans text-xl sm:text-2xl font-semibold leading-normal tracking-[-0.48px]">
// 								{text}
// 							</p>
// 						</div>
// 					))}
...
// 			{/* Who Are We */}
// 			<section className="bg-light-gray px-[5%] xl:px-[74px] pt-8 xl:pt-[158px] pb-[140px]">
// 				<div className="">
...
// 							WHO WE ARE
// 						</h2>
// 						<hr className="w-[158px] xs:w-[200px] sm:w-[225px] h-[3px] bg-gold-gradient absolute bottom-0 left-1/2 -translate-x-1/2 md:left-0 md:-translate-x-0" />
// 					</div>
...
// 						<div>
// 							<h3 className="text-light-black font-open-sans text-xl sm:text-[2rem] font-normal sm:leading-[28px] underline text-center md:text-start mb-6">
// 								We love what we do at DNBL
// 							</h3>
// 							<p className="text-[#1E1E1E] text-justify font-open-sans text-base lg:text-lg xl:text-2xl xl:leading-[40px] font-normal tracking-[0.02rem] pb-8 lg:pb-[22px] 2xl:w-[716px]">
// 								D'Nobles Fashion House envisions a world where Nigerian elegance
// 								and heritage are celebrated globally through premium fashion. We
// 								aim to bridge cultures with exquisite products embodying
// 								Nigeria's vibrant traditions and sophisticated craftsmanship.
// 								Our goal is to inspire pride and connection among the Nigerian
// 								diaspora and fashion enthusiasts worldwide.
// 							</p>
...
// 			{/* Trendy Products */}
// 			<section className="pt-[38px] px-[5%] xl:px-[74px] pb-[68px] bg-light-brown-gold">
// 				<h2 className="home-heading pb-2 sm:pb-4">TRENDY PRODUCTS</h2>

// 				<p className="home-headline pb-11">
...
// 			{/* Featured Products */}
// 			<section className="pt-[100px] px-[5%] xl:px-[74px] pb-[68px] bg-[#FDFDFD]">
// 				<h2 className="home-heading pb-2">FEATURED PRODUCTS</h2>

// 				<p className="home-headline pb-6">
...
// 			{/* Why Choose Us */}
// 			<section className="pt-[89px] px-[5%] 2xl:pl-[95px] 2xl:pr-[105px] pb-24 sm:pb-[164px] bg-white relative">
// 				<h2 className="home-heading mb-10 sm:mb-[60px]">WHY CHOOSE US?</h2>
...
// 			{/* Get in Touch */}
// 			<section className="px-[5%] pt-[54.8px] pb-11 text-center items-center bg-[#FFF6E9] mb-[88px]">
// 				<div className="md:w-[719.72px] mx-auto">
// 					<p className="font-extrabold text-base xs:text-xl text-gold-text font-open-sans">
// 						GET IN TOUCH
// 					</p>
// 					<h2 className="text-2xl xs:text-3xl font-bold font-open-sans text-[#333] my-5 xs:mt-6 xs:mb-[27px]">
// 						Your Feedback Matters: Embrace a Journey of Collaboration with Us!
// 					</h2>
// 					<p className="text-[#767676] text-xs font-open-sans mb-6 sm:mb-[44.96px]">
