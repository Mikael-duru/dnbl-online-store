...
const Cart = () => {
	...
	return (
		<div className="flex gap-20 pt-10 pb-16 px-[100px] max-lg:flex-col max-2xl:px-[5%] bg-white dark:bg-[#2E2E2E]">
			...
			<div className="w-1/3 max-lg:w-full flex flex-col gap-4 px-4 py-5">
				...
				<div className="flex justify-between text-base font-open-sans font-semibold my-4 dark:text-white">
					<span>Subtotal</span>
